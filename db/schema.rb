...
ActiveRecord::Schema.define(version: 20150429055750) do
  ...
  add_index "comments", ["beat_id"], name: "index_comments_on_beat_id", using: :btree
  ...
  add_index "favorites", ["beat_id"], name: "index_favorites_on_beat_id", using: :btree
